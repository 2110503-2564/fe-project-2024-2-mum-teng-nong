  ...
  return (
    <main className="flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-900 to-gray-900">
      <div className="bg-white p-8 rounded-lg shadow-md w-[90%] max-w-md text-black">
        ...
        <p className="text-lg text-center mb-8"><span className="font-semibold">Student ID:</span> 6733112021</p>
        <p className="text-lg text-center mb-4"><span className="font-semibold">Name:</span> Chatchaphon</p>
        <p className="text-lg text-center mb-8"><span className="font-semibold">Student ID:</span> 6733048521</p>
        <p className="text-lg text-center mb-4"><span className="font-semibold">Name:</span> Supakit</p>
        <p className="text-lg text-center"><span className="font-semibold">Student ID:</span> 6733262421</p>
      </div>
    </main>
  );
}